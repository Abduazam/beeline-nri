...
use App\Services\Data\Position\Company\Update\UpdateService;
...
class Edit extends Component
{
    ...
    public function update(UpdateService $service): void
    {
        try {
            ...
            $service->update($validatedData['data'], $this->company);
    ...
    public function render(): View
    {
        ...
        return view('livewire.data.position.companies.edit', compact('languages'));
    }
}
