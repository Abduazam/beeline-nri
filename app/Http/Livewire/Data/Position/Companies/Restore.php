...
use App\Services\Data\Position\Company\Restore\RestoreService;
...
class Restore extends Component
{
    ...
    public function render(): View
    {
        ...
        return view('livewire.data.position.companies.restore', compact('languages'));
    }
}
