...
use App\Services\Data\Purpose\Update\UpdateService;
...
class Edit extends Component
{
    ...
    public function update(UpdateService $service): void
    {
        try {
            ...
            $service->update($validatedData['data'], $this->purpose);
    ...
    public function render(): View
    {
        ...
        return view('livewire.data.purposes.edit', compact('languages'));
    }
}
