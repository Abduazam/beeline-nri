<div class="me-1 d-inline-block">
    <x-modal.opens.restore target="#modal-restore-controller-{{ $this->controller->id }}" />

    <!-- Restore Controller Modal -->
    <div wire:ignore.self
         class="modal fade"
         id="modal-restore-controller-{{ $this->controller->id }}"
         tabindex="-1"
         role="dialog"
         aria-labelledby="modal-restore-controller-{{ $this->controller->id }}"
         aria-hidden="true">
        <div class="modal-dialog" style="top: 20%;" role="document">
            <div class="modal-content">
                <div class="block block-rounded shadow-none mb-0">
                    <form wire:submit.prevent="restore" class="form-border-radius">
                        <x-modal.header action="restore" model="controller" />
