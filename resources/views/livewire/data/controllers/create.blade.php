                    ...
                    <div class="block-content pb-2">
                        <div class="row w-100 h-100 p-0 m-0">
                            <div class="col-lg-4 col-sm-6 col-12 ps-0 mb-3">
                                ...
                                <select wire:model.debounce.500ms="region_id" class="form-select form-select-sm @error('region_id'){{ 'is-invalid mb-1' }}@enderror" name="region_id" id="region_id">
                            ...
                            <div class="col-lg-4 col-sm-6 col-12 mb-3">
                                ...
                                <input wire:model.debounce.500ms="number" type="text" class="form-control form-control-sm @error('number'){{ 'is-invalid mb-1' }}@enderror" id="number" name="number">
                                @error('number')
                                <span class="text-danger small">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-lg-4 col-sm-6 col-12 pe-0 mb-3">
                                ...
                                <select wire:model.debounce.500ms="state_id" class="form-select form-select-sm @error('state_id'){{ 'is-invalid mb-1' }}@enderror" name="state_id" id="state_id">
                                    <option value="0">{{ \App\Models\Widget\TextName::getTextTranslation('choose-value') }}</option>
                            ...
                            <div class="col-lg-4 col-sm-6 col-12 ps-0 mb-3">
                                ...
                                <input wire:model.debounce.500ms="name" type="text" class="form-control form-control-sm @error('name'){{ 'is-invalid mb-1' }}@enderror" id="name" name="name">
                                @error('name')
                                <span class="text-danger small">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-lg-2 col-sm-6 col-12 mb-3">
                                ...
                                <input wire:model.debounce.500ms="gfk" type="text" class="form-control form-control-sm @error('gfk'){{ 'is-invalid mb-1' }}@enderror" id="gfk" name="gfk">
                                @error('gfk')
                                <span class="text-danger small">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-lg-6 col-sm-6 col-12 pe-0 mb-3">
                                ...
                                <input wire:model.debounce.500ms="address" type="text" class="form-control form-control-sm @error('address'){{ 'is-invalid mb-1' }}@enderror" id="address" name="address">
                                @error('address')
                                <span class="text-danger small">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-sm-6 col-12 ps-0 mb-3">
                                ...
                                <input wire:model.debounce.500ms="position" type="text" class="form-control form-control-sm @error('position'){{ 'is-invalid mb-1' }}@enderror" id="position" name="position">
                                @error('position')
                                <span class="text-danger small">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-sm-6 col-12 pe-0 mb-3">
                                ...
                                <input wire:model.debounce.500ms="number_position" type="text" class="form-control form-control-sm @error('number_position'){{ 'is-invalid mb-1' }}@enderror" id="number_position" name="number_position">
