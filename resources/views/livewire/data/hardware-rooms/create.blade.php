<div>
    ...
    <x-modal.opens.create target="#modal-create-hardware-room" />

    <!-- Create Hardware Room Modal -->
    <div wire:ignore.self class="modal fade" id="modal-create-hardware-room" tabindex="-1" role="dialog" aria-labelledby="modal-create-hardware-room" aria-hidden="true">
        <div class="modal-dialog" style="top: 20%;" role="document">
            <div class="modal-content">
                <div class="block block-rounded shadow-none mb-0">
                    <form wire:submit.prevent="store" class="form-border-radius">
                        <x-modal.header action="create" model="hardware-room" />
