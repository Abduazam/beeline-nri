<div>
    ...
    <x-modal.opens.create target="#modal-create-company" />

    <!-- Create Company Modal -->
    <div wire:ignore.self class="modal fade" id="modal-create-company" tabindex="-1" role="dialog" aria-labelledby="modal-create-company" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="block block-rounded shadow-none mb-0">
                    <form wire:submit.prevent="store" class="form-border-radius">
                        <x-modal.header action="create" model="company" />
