<div>
    ...
    <x-modal.opens.restore target="#modal-restore-technology-{{ $this?->technology?->id }}" />

    <!-- Restore Technology Modal -->
    <div wire:ignore.self class="modal fade" id="modal-restore-technology-{{ $this?->technology?->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-restore-technology-{{ $this?->technology?->id }}" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="block block-rounded shadow-none mb-0">
                    <form wire:submit.prevent="restore" class="form-border-radius">
                        <x-modal.header action="restore" model="technology" />
