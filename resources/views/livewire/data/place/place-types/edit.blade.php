<div>
    ...
    <x-modal.opens.edit target="#modal-edit-place-type-{{ $this?->type?->id }}" />

    <!-- Edit Place Type Modal -->
    <div wire:ignore.self class="modal fade" id="modal-edit-place-type-{{ $this?->type?->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-edit-place-type-{{ $this?->type?->id }}" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="block block-rounded shadow-none mb-0">
                    <form wire:submit.prevent="update" class="form-border-radius">
                        <x-modal.header action="edit" model="place-type" />
