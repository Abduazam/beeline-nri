                    ...
                    <div class="block-content">
                        <div class="row mb-4">
                            <div class="col-6">
                                ...
                                <input wire:model.debounce.500ms="name" type="text" class="form-control @error('name'){{ 'is-invalid mb-1' }}@enderror" id="name" name="name" placeholder="{{ $enter_value }}">
                                @error('name')
                            ...
                            <div class="col-6">
                                ...
                                <input wire:model.debounce.500ms="email" type="email" class="form-control @error('email'){{ 'is-invalid mb-1' }}@enderror" id="email" name="email" placeholder="{{ $enter_value }}">
                                @error('email')
                                <span class="text-danger small">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-6">
                                ...
                                <select wire:model.debounce.500ms="role_id" class="form-select @error('role_id'){{ 'is-invalid mb-1' }}@enderror" id="role_id" name="role_id">
                            ...
                            <div class="col-6">
                                <div class="w-100" wire:ignore>
                                    ...
                                    <select wire:model="user_branches" class="js-select2 form-select" id="user_branches" name="user_branches" data-placeholder="{{ $choose_value }}" multiple>
                                        <option></option>
                        ...
                        <div class="row mb-4">
                            <div class="col-6">
                                <label class="form-label fs-sm" for="password">{{ \App\Models\Widget\TableColumnName::getColumnTranslation('users', 'password') }} <x-texts.required-sign /></label>
                            ...
                            <div class="col-6">
                                <label class="form-label fs-sm" for="password_confirmation">{{ \App\Models\Widget\TextName::getTextTranslation('confirm-password') }} <x-texts.required-sign /></label>
