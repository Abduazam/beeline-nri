            ...
            <div class="col-12 ps-0">
                <div class="block block-rounded">
                    <div class="block-header bg-elegance-dark py-2">
                        <h3 class="block-title fs-sm text-white text-center mt-1">{{ \App\Models\Widget\TextName::getTextTranslation('application-for') . ' ' . mb_strtolower(\App\Models\Widget\TextName::getTextTranslation('edit')) . ' ' . mb_strtolower(\App\Models\Widget\TextName::getTextTranslation('position')) }}</h3>
                    </div>
                    <div class="block-content">
                        <div class="row w-100 h-100 p-0 m-0">
                            <div class="col-lg-4 ps-0 mb-3">
                                ...
                                <input value="{{ $position->id }}" type="text" class="form-control form-control-sm" id="id" name="id" readonly disabled>
                            </div>
                            <div class="col-lg-4 mb-3">
                                ...
                                <input wire:model="source" type="text" class="form-control form-control-sm" id="source" name="source" readonly disabled>
                            </div>
                            <div class="col-lg-4 pe-0 mb-3">
                                ...
                                <select wire:model.debounce.500ms="company_id" class="form-select form-select-sm @error('company_id'){{ 'is-invalid mb-1' }}@enderror" name="company_id" id="company_id">
                            ...
                            <div class="col-lg-4 ps-0 mb-3">
                                ...
                                <select wire:model="place_type_id" wire:blur="handlePlaceTypeId" class="form-select form-select-sm @error('place_type_id'){{ 'is-invalid mb-1' }}@enderror" name="place_type_id" id="place_type_id">
                            ...
                            <div class="col-lg-4 mb-3">
                                ...
                                <select wire:model="place_type_group_id" class="form-select form-select-sm @error('place_type_group_id'){{ 'is-invalid mb-1' }}@enderror" name="place_type_group_id" id="place_type_group_id">
                                    <option value="0">{{ $choose_value }}</option>
                            ...
                            <div class="col-lg-4 pe-0 mb-3">
                                ...
                                <select wire:model="purpose_id" class="form-select form-select-sm @error('urpose_id'){{ 'is-invalid mb-1' }}@enderror" name="purpose_id" id="purpose_id">
                                    <option value="0">{{ $choose_value }}</option>
                            ...
                            <div class="col-lg-4 ps-0 mb-3">
                                ...
                                <select wire:model="region_id" wire:blur="handleRegionId" class="form-select form-select-sm @error('region_id'){{ 'is-invalid mb-1' }}@enderror" name="region_id" id="region_id">
                                    <option value="0">{{ $choose_value }}</option>
                            ...
                            <div class="col-lg-4 mb-3">
                                ...
                                <select wire:model="area_id" class="form-select form-select-sm @error('area_id'){{ 'is-invalid mb-1' }}@enderror" name="area_id" id="area_id">
                                    <option value="0">{{ $choose_value }}</option>
                            ...
                            <div class="col-lg-4 pe-0 mb-4">
                                ...
                                <select wire:model="territory_id" class="form-select form-select-sm @error('territory_id'){{ 'is-invalid mb-1' }}@enderror" name="territory_id" id="territory_id">
                                    <option value="0">{{ $choose_value }}</option>
                            ...
                            <div class="col-lg-5 ps-0 mb-4">
                                ...
                                <input wire:model="name" type="text" class="form-control form-control-sm @error('name'){{ 'is-invalid mb-1' }}@enderror" id="name" name="name">
                                @error('name')
                                <span class="text-danger small">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-lg-7 pe-0 mb-4">
                                ...
                                <input wire:model="address" type="text" class="form-control form-control-sm @error('address'){{ 'is-invalid mb-1' }}@enderror" id="address" name="address">
                                @error('address')
                                <span class="text-danger small">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="block-content">
                        <div class="row w-100 h-100 p-0 m-0">
                            <div class="col-lg-3 ps-0 mb-4">
                                ...
                                <select wire:model="coordinate_id" class="form-select form-select-sm @error('coordinate_id'){{ 'is-invalid mb-1' }}@enderror" name="coordinate_id" id="coordinate_id">
                    ...
                    <div class="block-content">
                        <div class="row w-100 h-100 p-0 m-0">
                            ...
                            <div class="col-12 px-0 mb-4">
                                ...
                                <textarea wire:model="comment" class="form-control form-control-sm" id="comment" name="comment" rows="4" placeholder=""></textarea>
                            </div>
                        </div>
                    </div>
                </div>
