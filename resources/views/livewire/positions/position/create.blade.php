                    ...
                    <div class="block-content">
                        <div class="row w-100 h-100 p-0 m-0">
                            <div class="col-lg-6 ps-0 mb-3">
                                ...
                                <input wire:model.debounce.500ms="source" type="text" class="form-control form-control-sm @error('source'){{ 'is-invalid mb-1' }}@enderror" id="source" name="source" readonly disabled>
                                @error('source')
                                <span class="text-danger small">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-lg-6 pe-0 mb-3">
                    ...
                    <div class="block-content">
                        <div class="row w-100 h-100 p-0 m-0">
                            ...
                            <div class="col-12 px-0 mb-4">
                                <label for="comment" class="form-label fs-sm">{{ \App\Models\Widget\TableColumnName::getColumnTranslation('positions', 'comment') }}:</label>
