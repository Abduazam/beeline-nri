<div>
    ...
    <x-modal.opens.edit target="#modal-edit-base-station-workflow-{{ $this->workflow->id }}" />

    <!-- Edit BaseStation Workflow Modal -->
    <div wire:ignore.self
         class="modal fade"
         id="modal-edit-base-station-workflow-{{ $this->workflow->id }}"
         tabindex="-1"
         role="dialog"
         aria-labelledby="modal-edit-base-station-workflow-{{ $this->workflow->id }}"
         aria-hidden="true">
        <div class="modal-dialog" style="top: 20%;" role="document">
            <div class="modal-content">
                <div class="block block-rounded shadow-none mb-0">
                    <form wire:submit.prevent="update" class="form-border-radius">
                        <x-modal.header action="edit" model="base-station-workflow" />
