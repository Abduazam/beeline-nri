<div>
    <x-modal.opens.restore target="#modal-restore-base-station-workflow-user-{{ $this->user->id }}" />

    <!-- Restore BaseStation Workflow User Modal -->
    <div wire:ignore.self
         class="modal fade"
         id="modal-restore-base-station-workflow-user-{{ $this->user->id }}"
         tabindex="-1"
         role="dialog"
         aria-labelledby="modal-restore-base-station-workflow-user-{{ $this->user->id }}"
         aria-hidden="true">
