<div class="ms-1">
    <x-modal.opens.delete target="#modal-delete-position-workflow-user-{{ $this->user->id }}" />

    <!-- Delete Position Workflow User Modal -->
    <div wire:ignore.self
         class="modal fade"
         id="modal-delete-position-workflow-user-{{ $this->user->id }}"
         tabindex="-1"
         role="dialog"
         aria-labelledby="modal-delete-position-workflow-user-{{ $this->user->id }}"
         aria-hidden="true">
