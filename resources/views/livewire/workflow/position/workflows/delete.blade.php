<div class="ms-1">
    <x-modal.opens.delete target="#modal-delete-position-workflow-{{ $this->workflow->id }}" />

    <!-- Delete Position Workflow Modal -->
    <div wire:ignore.self
         class="modal fade"
         id="modal-delete-position-workflow-{{ $this->workflow->id }}"
         tabindex="-1"
         role="dialog"
         aria-labelledby="modal-delete-position-workflow-{{ $this->workflow->id }}"
         aria-hidden="true">
        <div class="modal-dialog" style="top: 20%;" role="document">
            <div class="modal-content">
                <div class="block block-rounded shadow-none mb-0">
                    <form wire:submit.prevent="delete" class="form-border-radius">
                        <x-modal.header action="delete" model="position-workflow" />
