<div class="ms-3">
    @if(!is_null($this->bts_type_model))
        <button type="button" class="btn btn-sm" data-bs-toggle="modal" data-bs-target="#modal-cabinet-bts{{ $key }}"><u>{{ $this->bts_type_model }}</u></button>
    @else
        <button type="button" class="btn btn-sm btn-alt-primary" data-bs-toggle="modal" data-bs-target="#modal-cabinet-bts{{ $key }}">
            <i class="fa fa-file-pen"></i>
        </button>
    @endif

    <div wire:ignore.self class="modal fade" id="modal-cabinet-bts{{ $key }}" tabindex="-1" role="dialog" aria-labelledby="modal-cabinet-bts{{ $key }}" aria-hidden="true">
